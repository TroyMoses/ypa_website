      ...
      <section className="py-20 bg-gradient-to-r from-primary/10 to-primary/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Get in touch with our team. We're here to help you on your agricultural journey and answer any questions you
            may have.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">support@youthplatformafrica.org</p>
                </div>
              </div>
            ...
            {/* Regional Offices */}
            <div>
              <h3 className="text-lg font-semibold font-serif mb-4">Regional Offices</h3>
            ...
            <CardContent className="p-8">
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <Textarea placeholder="Please provide details about your inquiry..." rows={5} required />
                </div>

                <div className="flex items-start gap-2">
                  <input type="checkbox" id="newsletter" className="mt-1" />
                  <label htmlFor="newsletter" className="text-sm text-gray-600">
                    I would like to receive updates and newsletters from Youth Platform Africa
                  </label>
                </div>
        ...
        {/* Map Section */}
        <div className="mt-20">
          <h2 className="text-2xl font-bold font-serif mb-8 text-center">Find Us</h2>
          <Card>
            <CardContent className="p-0">
              <div className="bg-gray-200 h-96 rounded-lg flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-500">123 Buganda Road, Kampala, Uganda</p>
                </div>
              </div>
            </CardContent>
          </Card>
